...
#           BR         NDA      ID1       ID2 
0.00000000E+00    3     1000022        -5      5     # Dummy decay to allow off-shell H
1.000000000E+00   2     1000022        25            # BR(N2 -> N1 + H)
...
# -------------------------------
#    Only the requested two reference [mGlu, mC1] points + mN2 scan


mpoints = []
for mn2 in xrange(200,1801,200):
   mpoints.append([2000,mn2,1,nev])
for mn2 in xrange(1100,1301,50):
   mpoints.append([1400,mn2,1000,nev])



for point in mpoints:
  
    mglu, mnlsp, mlsp = point[0], point[1], point[2]
    qcut, tru_eff = matchParams(mglu)
    wgt = point[3]*(mcm_eff/tru_eff)
