...
#requests_to_clone = [ 'SUS-RunIISummer16FSPremix-00143', 
#                      'SUS-RunIISummer16FSPremix-00144',
#                       ] 
requests_to_clone = [ ]
list0 = list('SUS-RunIISummer16FSPremix-00' + str(i) for i in range(179,183+1))
for req in list0:
...
campaign_modifications = {'member_of_campaign': 'RunIIFall17FSPremix'}
...
for request_prepid_to_clone in requests_to_clone:
    ...
    modifications = {'dataset_name'   : datasetname,
                     'fragment'       : fragment,
                     'extension'      : 0,
                     'total_events'   : int(total_events*1.1),
                     'process_string' : '',
                     #'memory'         : 4000,
                     'keep_output'    : [False] 
