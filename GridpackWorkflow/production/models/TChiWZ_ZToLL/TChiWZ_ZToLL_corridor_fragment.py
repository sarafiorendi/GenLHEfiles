...
diagStep = 100
maxDM = 150
extras = range(90,101,1)

scanBlocks = []
scanBlocks.append(gridBlock(100, 1001, 25, 25))
minDM = 2000
ymin, ymed, ymax = 601, 0, 600  
...
for point in mpoints:
    ...
    print mn2, mlsp, mn2-mlsp, point[2]
    if mlsp==0: mlsp = 1
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.4.2/sus_sms/LO_PDF/SMS-C1N2/v1/SMS-C1N2_mC1-%i_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz' % mn2),
