...
charginodecaySLHATable="""
BLOCK MASS
#  PDG code   mass   particle
   1000022   %MLSP%   # n1
   1000024   %MCHI%   # x1+
# DECAY TABLE
DECAY   1000024  %WCHI% # x1+ decays
#          BR          NDA       ID1     ID2
           1.0         2         -11    1000022         # x1+  -->  n1 pi+(e+)
"""

model = "T1qqqq-LLChipm_ctau-50"
...
scanBlocks = []
scanBlocks.append(gridBlock(1000,  1401, 200, 200, 1000, 100, 40))
minDM = 25
ymin, ymed, ymax = 0, 800, 400  
