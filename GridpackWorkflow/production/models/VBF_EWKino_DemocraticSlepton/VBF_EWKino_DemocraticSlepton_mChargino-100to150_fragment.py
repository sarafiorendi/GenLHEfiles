...
#          BR         NDA      ID1       ID2
      ...
      0.000000E+00     2        11    1000023 # br(~e_l -> ~chi_20 e-)
      0.000000E+00     2        11    1000025 # br(~e_l -> ~chi_30 e-)
      0.000000E+00     2        11    1000035 # br(~e_l -> ~chi_40 e-)
      0.000000E+00     2    -1000024     12   # br(~e_l -> ~chi_1- nu_e)
...
#          BR         NDA      ID1       ID2
      ...
      0.000000E+00     2       13      1000023 # br(~mu_l -> ~chi_20 mu-)
      0.000000E+00     2       13      1000025 # br(~mu_l -> ~chi_30 mu-)
      0.000000E+00     2       13      1000035 # br(~mu_l -> ~chi_40 mu-)
      0.000000E+00     2    -1000024     14    # br(~mu_l -> ~chi_1- nu_mu)
...
#          BR         NDA      ID1       ID2
     ...
     0.16666666E-01    2     1000011       -11   # BR(~chi_20 -> ~e_L-     e+)
     0.16666666E-01    2    -1000011        11   # BR(~chi_20 -> ~e_L+     e-)
     0.00000000E+00    2     2000011       -11   # BR(~chi_20 -> ~e_R-     e+)
     0.00000000E+00    2    -2000011        11   # BR(~chi_20 -> ~e_R+     e-)
     0.16666666E-01    2     1000013       -13   # BR(~chi_20 -> ~mu_L-    mu+)
     0.16666666E-01    2    -1000013        13   # BR(~chi_20 -> ~mu_L+    mu-)
     0.00000000E+00    2     2000013       -13   # BR(~chi_20 -> ~mu_R-    mu+)
     0.00000000E+00    2    -2000013        13   # BR(~chi_20 -> ~mu_R+    mu-)
     0.16666666E-01    2     1000015       -15   # BR(~chi_20 -> ~tau_1-   tau+)
     0.16666666E-01    2    -1000015        15   # BR(~chi_20 -> ~tau_1+   tau-)
...
model = "VBF_EWKino_DemocraticSlepton_mChargino-100to150"
...
scanBlocks = []
scanBlocks.append(gridBlock(100, 151, 25))
