...
./gridpack_generation_325300.sh ${PROCESS} cards/${PROCESS} 

#copy output
echo "Copy output"
ls ${PROCESS}_*_tarball.tar.xz
mv ${PROCESS}_slc7_amd64_gcc700_CMSSW_10_6_0_tarball.tar.xz ${PROCESS}_tarball.tar.xz
...
gfal-copy -p -f -t 4200 ${PROCESS}_tarball.tar.xz ${OUTDIR}/${PROCESS}_tarball.tar.xz --checksum ADLER32
...
gfal-copy -p -f -t 4200 ${PROCESS}.log ${OUTDIR}/${PROCESS}.log --checksum ADLER32
