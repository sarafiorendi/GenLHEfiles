...
if __name__ == '__main__':
    ...
    executable = script_dir+'/runGridpackGeneration_325300.sh'
    ...
    infile_list = [script_dir+'/gridpack_generation_325300.sh'] #use modified gridpack generation script 
    infile_list.append(script_dir+'/runcmsgrid_LO_325300.sh')
